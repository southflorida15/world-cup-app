...
function html(req,d){
  ...
  const marketRow = showMarket ? `<div class="row"><div class="ico">🎲</div><div><div class="label">Win Probability</div><div class="value">${esc(d.home)}: ${esc(d.homeSim||d.homePoly||'—')}%</div><div class="sub">Draw: ${esc(d.drawSim||'—')}% • ${esc(d.away)}: ${esc(d.awaySim||d.awayPoly||'—')}%</div></div><div></div></div>` : '';
