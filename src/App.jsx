...
const RECENT4 = {
  "Argentina":[{date:"Apr 1, 2026",opp:"Zambia",score:"5-0",loc:"Buenos Aires",comp:"Friendly",res:"W"},{date:"Mar 28, 2026",opp:"Mauritania",score:"2-1",loc:"Buenos Aires",comp:"Friendly",res:"W"},{date:"Nov 14, 2025",opp:"Angola",score:"2-0",loc:"Luanda",comp:"Friendly",res:"W"},{date:"Oct 15, 2025",opp:"Puerto Rico",score:"6-0",loc:"San Juan",comp:"Friendly",res:"W"}],
  "France":[{date:"Mar 29, 2026",opp:"Colombia",score:"3-1",loc:"Paris",comp:"Friendly",res:"W"},{date:"Mar 26, 2026",opp:"Brazil",score:"2-1",loc:"Paris",comp:"Friendly",res:"W"},{date:"Nov 16, 2025",opp:"Azerbaijan",score:"3-1",loc:"Baku",comp:"WC Qualifier",res:"W"},{date:"Nov 13, 2025",opp:"Iceland",score:"2-2",loc:"Reykjavik",comp:"WC Qualifier",res:"D"}],
  "Brazil":[{date:"Mar 26, 2026",opp:"France",score:"1-2",loc:"Paris",comp:"Friendly",res:"L"},{date:"Mar 22, 2026",opp:"Germany",score:"2-1",loc:"Frankfurt",comp:"Friendly",res:"W"},{date:"Nov 18, 2025",opp:"Uruguay",score:"2-1",loc:"Montevideo",comp:"WC Qualifier (CONMEBOL)",res:"W"},{date:"Nov 14, 2025",opp:"Venezuela",score:"3-0",loc:"Brasilia",comp:"WC Qualifier (CONMEBOL)",res:"W"}],
  "England":[{date:"Mar 31, 2026",opp:"Japan",score:"0-1",loc:"London, Wembley",comp:"Friendly",res:"L"},{date:"Mar 27, 2026",opp:"Uruguay",score:"1-1",loc:"London, Wembley",comp:"Friendly",res:"D"},{date:"Nov 16, 2025",opp:"Albania",score:"2-0",loc:"Tirana",comp:"WC Qualifier (UEFA)",res:"W"},{date:"Nov 13, 2025",opp:"Serbia",score:"2-0",loc:"London, Wembley",comp:"WC Qualifier (UEFA)",res:"W"}],
  "Spain":[{date:"Mar 28, 2026",opp:"Portugal",score:"1-1",loc:"Seville",comp:"Friendly",res:"D"},{date:"Mar 25, 2026",opp:"Germany",score:"2-0",loc:"Madrid",comp:"Friendly",res:"W"},{date:"Nov 15, 2025",opp:"Turkiye",score:"2-2",loc:"Istanbul",comp:"WC Qualifier (UEFA)",res:"D"},{date:"Nov 11, 2025",opp:"Denmark",score:"3-0",loc:"Madrid",comp:"WC Qualifier (UEFA)",res:"W"}],
  "Germany":[{date:"May 26, 2026",opp:"Ghana",score:"2-1",loc:"Nuremberg",comp:"Friendly",res:"W"},{date:"Mar 25, 2026",opp:"Spain",score:"0-2",loc:"Madrid",comp:"Friendly",res:"L"},{date:"Mar 22, 2026",opp:"Brazil",score:"1-2",loc:"Frankfurt",comp:"Friendly",res:"L"},{date:"Nov 16, 2025",opp:"Slovakia",score:"6-0",loc:"Dusseldorf",comp:"WC Qualifier (UEFA)",res:"W"}],
  "Portugal":[{date:"Mar 28, 2026",opp:"Spain",score:"1-1",loc:"Seville",comp:"Friendly",res:"D"},{date:"Mar 24, 2026",opp:"Argentina",score:"1-1",loc:"Lisbon",comp:"Friendly",res:"D"},{date:"Nov 15, 2025",opp:"Armenia",score:"9-1",loc:"Lisbon",comp:"WC Qualifier (UEFA)",res:"W"},{date:"Jun 8, 2025",opp:"Spain",score:"2-2 (5-3p)",loc:"Munich",comp:"UEFA Nations League Final",res:"W"}],
  "Netherlands":[{date:"Mar 26, 2026",opp:"Cameroon",score:"4-0",loc:"Amsterdam",comp:"Friendly",res:"W"},{date:"Mar 22, 2026",opp:"Portugal",score:"2-1",loc:"Rotterdam",comp:"Friendly",res:"W"},{date:"Nov 15, 2025",opp:"Lithuania",score:"4-0",loc:"Amsterdam",comp:"WC Qualifier (UEFA)",res:"W"},{date:"Nov 11, 2025",opp:"Malta",score:"8-0",loc:"Eindhoven",comp:"WC Qualifier (UEFA)",res:"W"}],
  "Belgium":[{date:"Mar 29, 2026",opp:"United States",score:"2-0",loc:"Brussels",comp:"Friendly",res:"W"},{date:"Mar 25, 2026",opp:"Portugal",score:"1-3",loc:"Lisbon",comp:"Friendly",res:"L"},{date:"Nov 15, 2025",opp:"Liechtenstein",score:"7-0",loc:"Brussels",comp:"WC Qualifier (UEFA)",res:"W"},{date:"Nov 11, 2025",opp:"Wales",score:"4-3",loc:"Brussels",comp:"WC Qualifier (UEFA)",res:"W"}],
  "Norway":[{date:"Mar 28, 2026",opp:"Scotland",score:"3-1",loc:"Oslo",comp:"Friendly",res:"W"},{date:"Mar 24, 2026",opp:"Turkiye",score:"2-0",loc:"Oslo",comp:"Friendly",res:"W"},{date:"Nov 14, 2025",opp:"Italy",score:"4-1",loc:"Rome",comp:"WC Qualifier (UEFA)",res:"W"},{date:"Nov 11, 2025",opp:"Estonia",score:"1-0",loc:"Oslo",comp:"WC Qualifier (UEFA)",res:"W"}],
  "Mexico":[{date:"Mar 28, 2026",opp:"Costa Rica",score:"2-0",loc:"Mexico City",comp:"Friendly",res:"W"},{date:"Mar 24, 2026",opp:"Chile",score:"1-1",loc:"Mexico City",comp:"Friendly",res:"D"},{date:"Nov 18, 2025",opp:"Canada",score:"2-1",loc:"Toronto",comp:"Concacaf Nations League",res:"W"},{date:"Nov 14, 2025",opp:"United States",score:"2-2",loc:"Mexico City",comp:"Concacaf Nations League",res:"D"}],
  "United States":[{date:"Mar 29, 2026",opp:"Belgium",score:"0-2",loc:"Brussels",comp:"Friendly",res:"L"},{date:"Mar 25, 2026",opp:"Germany",score:"1-2",loc:"Dusseldorf",comp:"Friendly",res:"L"},{date:"Nov 18, 2025",opp:"Jamaica",score:"3-0",loc:"Austin",comp:"Concacaf Nations League",res:"W"},{date:"Nov 14, 2025",opp:"Mexico",score:"2-2",loc:"Mexico City",comp:"Concacaf Nations League",res:"D"}],
  "Morocco":[{date:"Mar 27, 2026",opp:"Senegal",score:"1-0",loc:"Casablanca",comp:"Friendly",res:"W"},{date:"Mar 23, 2026",opp:"Egypt",score:"2-1",loc:"Casablanca",comp:"Friendly",res:"W"},{date:"Nov 19, 2025",opp:"Gabon",score:"3-0",loc:"Rabat",comp:"AFCON Qualifier",res:"W"},{date:"Nov 15, 2025",opp:"Tanzania",score:"4-0",loc:"Dar es Salaam",comp:"AFCON Qualifier",res:"W"}],
  "Uruguay":[{date:"Mar 29, 2026",opp:"England",score:"1-1",loc:"London",comp:"Friendly",res:"D"},{date:"Mar 24, 2026",opp:"Algeria",score:"1-1",loc:"Paris",comp:"Friendly",res:"D"},{date:"Nov 18, 2025",opp:"Brazil",score:"1-2",loc:"Montevideo",comp:"WC Qualifier (CONMEBOL)",res:"L"},{date:"Nov 14, 2025",opp:"Argentina",score:"0-1",loc:"Montevideo",comp:"WC Qualifier (CONMEBOL)",res:"L"}],
  "Colombia":[{date:"Mar 29, 2026",opp:"France",score:"1-3",loc:"Paris",comp:"Friendly",res:"L"},{date:"Mar 25, 2026",opp:"Netherlands",score:"2-2",loc:"Amsterdam",comp:"Friendly",res:"D"},{date:"Nov 18, 2025",opp:"Ecuador",score:"2-0",loc:"Bogota",comp:"WC Qualifier (CONMEBOL)",res:"W"},{date:"Nov 14, 2025",opp:"Peru",score:"3-0",loc:"Barranquilla",comp:"WC Qualifier (CONMEBOL)",res:"W"}],
  "Croatia":[{date:"Mar 28, 2026",opp:"Sweden",score:"2-0",loc:"Zagreb",comp:"Friendly",res:"W"},{date:"Mar 24, 2026",opp:"Denmark",score:"1-1",loc:"Copenhagen",comp:"Friendly",res:"D"},{date:"Nov 15, 2025",opp:"Montenegro",score:"2-3",loc:"Podgorica",comp:"WC Qualifier (UEFA Playoff)",res:"L"},{date:"Nov 11, 2025",opp:"Czechia",score:"5-1",loc:"Zagreb",comp:"WC Qualifier (UEFA Playoff)",res:"W"}],
  "Japan":[{date:"Mar 31, 2026",opp:"England",score:"1-0",loc:"London, Wembley",comp:"Friendly",res:"W"},{date:"Mar 27, 2026",opp:"France",score:"0-2",loc:"Paris",comp:"Friendly",res:"L"},{date:"Nov 19, 2025",opp:"China",score:"3-1",loc:"Tokyo",comp:"WC Qualifier (AFC)",res:"W"},{date:"Nov 15, 2025",opp:"Indonesia",score:"4-0",loc:"Jakarta",comp:"WC Qualifier (AFC)",res:"W"}],
  "Senegal":[{date:"Mar 27, 2026",opp:"Morocco",score:"0-1",loc:"Casablanca",comp:"Friendly",res:"L"},{date:"Mar 23, 2026",opp:"Ivory Coast",score:"1-1",loc:"Dakar",comp:"Friendly",res:"D"},{date:"Nov 14, 2025",opp:"Botswana",score:"3-0",loc:"Dakar",comp:"AFCON Qualifier",res:"W"},{date:"Nov 10, 2025",opp:"Mozambique",score:"2-0",loc:"Maputo",comp:"AFCON Qualifier",res:"W"}],
};
...
// Home venues for host nations
const HOME_VENUES = {
  "United States":["SoFi Stadium, Los Angeles","New York New Jersey Stadium, East Rutherford","Dallas Stadium, Dallas","San Francisco Bay Area Stadium, San Francisco","Seattle Stadium, Seattle","Kansas City Stadium, Kansas City","Philadelphia Stadium, Philadelphia","Boston Stadium, Boston","Atlanta Stadium, Atlanta","Miami Stadium, Miami","Houston Stadium, Houston"],
  "Canada":["Toronto Stadium, Toronto","BC Place, Vancouver"],
  "Mexico":["Mexico City Stadium, Mexico City","Estadio Guadalajara, Zapopan","Estadio Monterrey, Guadalupe"],
};

// Form points: W=1, D=0.5, L=0
const formScore = team => {
  const d = TEAMS[team]; if(!d) return 0.5;
  const pts = d.form.slice(-5).reduce((s,r)=>s+(r==="W"?1:r==="D"?0.5:0),0);
  return 0.85 + (pts/5)*0.3; // multiplier 0.85–1.15
};

// Poisson random variate (Knuth)
...
// xG per 90 min based on strength rating (scaled 0.55–2.2)
const xG = rating => 0.55 + ((rating-37)/(87-37))*1.65;

function simMatch(home, away, venue="") {
  const hr = gs(home), ar = gs(away);
  // Home advantage: +4 rating if playing in own country's stadium
  const homeBoost = Object.entries(HOME_VENUES).some(([nation,venues])=>nation===home&&venues.includes(venue)) ? 4 : 0;
  // Expected goals with form modifier
  const hxg = xG(hr + homeBoost) * formScore(home);
  const axg = xG(ar)             * formScore(away);
  // Upset dampener: compress xG gap slightly so weak teams aren't obliterated
  const avgXg = (hxg+axg)/2;
  const hFinal = avgXg + (hxg-avgXg)*0.75;
  const aFinal = avgXg + (axg-avgXg)*0.75;
  // Draw goals to integers via Poisson
  const hg = poisson(hFinal);
  const ag = poisson(aFinal);
  const res = hg>ag?"home":hg<ag?"away":"draw";
  return {hg, ag, res};
}

// ── LIVE SCORES CONTEXT ───────────────────────────────────────────────────
const LiveScoresCtx = createContext({scores:{}, isLive:()=>false, isFinished:()=>false, getScore:()=>null});

const RAPIDAPI_KEY = "79e084bb92mshe49889427f83390p16a3c7jsn793e5bc48bb0";
const WC2026_LEAGUE_ID = 1;

function statusIsLive(s)     { return ["1H","HT","2H","ET","BT","P"].includes(s); }
function statusIsFinished(s) { return ["FT","AET","PEN"].includes(s); }

function statusLabel(s, elapsed) {
  if (s==="NS")   return null;
  if (s==="1H")   return `${elapsed}'`;
  if (s==="HT")   return "HT";
  if (s==="2H")   return `${elapsed}'`;
  if (s==="ET")   return `ET ${elapsed}'`;
  if (s==="BT")   return "BT";
  if (s==="P")    return "Pens";
  if (s==="FT")   return "FT";
  if (s==="AET")  return "AET";
  if (s==="PEN")  return "Pens";
  return s;
}

// Normalise API team names → our app team names
const API_NAME_MAP = {
  ...
  "New Zealand":"New Zealand","Korea Republic":"South Korea","South Korea":"South Korea",
  "Iran":"Iran","IR Iran":"Iran",
};
const normTeam = n => API_NAME_MAP[n] || n;

function LiveScoresProvider({children}) {
  const [scores, setScores] = useState({}); // key: "HomeTeam|AwayTeam" → {hg,ag,status,elapsed}

  const fetchAll = useCallback(async () => {
    try {
      const [liveRes, todayRes] = await Promise.all([
        fetch(`https://api-football-v1.p.rapidapi.com/v3/fixtures?league=${WC2026_LEAGUE_ID}&season=2026&live=all`,
          {headers:{"X-RapidAPI-Key":RAPIDAPI_KEY,"X-RapidAPI-Host":"api-football-v1.p.rapidapi.com"}}),
        fetch(`https://api-football-v1.p.rapidapi.com/v3/fixtures?league=${WC2026_LEAGUE_ID}&season=2026&date=${new Date().toISOString().split("T")[0]}`,
          {headers:{"X-RapidAPI-Key":RAPIDAPI_KEY,"X-RapidAPI-Host":"api-football-v1.p.rapidapi.com"}}),
      ]);
      ...
      const map = {};
      deduped.forEach(f => {
        const h = normTeam(f.teams.home.name), a = normTeam(f.teams.away.name);
        map[`${h}|${a}`] = {hg:f.goals.home, ag:f.goals.away, status:f.fixture.status.short, elapsed:f.fixture.status.elapsed};
      });
      setScores(map);
    } catch(e) {}
  }, []);
  ...
  const getScore = (home, away) => scores[`${home}|${away}`] || null;
...
const TSDB_NAMES = {
  ...
  "New Zealand":"New Zealand","Saudi Arabia":"Saudi Arabia","Cape Verde":"Cape Verde",
};
  ...
  useEffect(()=>{
    ...
    fetch(`https://www.thesportsdb.com/api/v1/json/3/searchteams.php?t=${encodeURIComponent(q)}`)
      .then(r=>r.json()).then(d=>{
        ...
        if(badge){const u=badge+"/preview";_cc[team]=u;setUrl(u);}else setErr(true);
      }).catch(()=>setErr(true));
  },[team]);
...
function downloadICS(saved) {
  ...
  const isIOS = /iPad|iPhone|iPod/.test(navigator.userAgent)&&!window.MSStream;
  if(isIOS){const w=window.open();if(w){w.document.open("text/calendar");w.document.write(ics);w.document.close();}else alert("Allow popups and try again.");}
  else{const a=document.createElement("a");a.href=URL.createObjectURL(new Blob([ics],{type:"text/calendar;charset=utf-8"}));a.download="WorldCup2026_Matches.ics";document.body.appendChild(a);a.click();document.body.removeChild(a);}
}

// ── ADD MODAL ─────────────────────────────────────────────────────────────
function AddModal({match,open,onClose,onCal,onRem}) {
  const [tab,setTab]=useState("cal"),[avail,setAvail]=useState("busy"),[mins,setMins]=useState(60),[ch,setCh]=useState("email"),[contact,setContact]=useState("");
...
function MatchCard({m, onAction}) {
  ...
  // Winner for knockout matches
  let winner = null;
  if(isKO && finished && hasScore) {
    if(sc.hg > sc.ag) winner = m.home;
    else if(sc.ag > sc.hg) winner = m.away;
    // draws go to AET/pens — mark both as TBD still
  }

  const cardBg = finished
    ? `linear-gradient(135deg,#080f0a,#0a1410)`
    : live
    ? `linear-gradient(135deg,#0a1f10,#0d2815)`
    : `linear-gradient(135deg,${C.s1},${C.s2})`;

  const cardBorder = live ? C.greenS : finished ? C.b1 : C.b1;
  const dimText  = finished ? C.dim : C.text;
  const dimMid   = finished ? "#2d5038" : C.mid;

  const TeamName = ({team, isWinner, align="left"}) => (
    <span style={{
      fontWeight: isWinner ? 800 : 700,
      color: finished ? (isWinner ? C.green : C.dim) : C.text,
      flex: 1, fontSize: 14, textAlign: align,
      textShadow: isWinner ? `0 0 12px ${C.green}66` : "none",
      overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap",
    }}>{team}</span>
  );

  const ScoreBlock = () => {
    if(!hasScore) return <span style={{fontSize:11,color:C.dim,fontWeight:700}}>VS</span>;
    const lbl = statusLabel(sc.status, sc.elapsed);
    const scoreCol = live ? C.green : finished ? (C.text) : C.gold;
    return <div style={{textAlign:"center",minWidth:64}}>
      <div style={{fontWeight:900,fontSize:22,color:scoreCol,fontFamily:"monospace",lineHeight:1}}>{sc.hg} – {sc.ag}</div>
      {lbl && <div style={{fontSize:10,fontWeight:700,marginTop:2,color:live?C.green:C.dim,background:live?`${C.green}18`:"transparent",borderRadius:8,padding:live?"1px 6px":"0"}}>{live&&"🔴 "}{lbl}</div>}
    </div>;
  };

  return <Card style={{marginBottom:8,border:`1px solid ${cardBorder}`,background:cardBg,opacity:finished?0.75:1,transition:"opacity .3s"}}>
    <div style={{padding:"11px 13px"}}>
      <div style={{display:"flex",justifyContent:"space-between",marginBottom:7}}>
        {m.group ? <Badge>Group {m.group}</Badge> : <Badge color={C.gold}>{m.stage||"Knockout"}</Badge>}
        <span style={{fontSize:11,color:finished?C.dim:C.dim}}>{m.time}</span>
      </div>
      <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:7}}>
        <Crest team={m.home} size={24}/>
        <TeamName team={m.home} isWinner={winner===m.home} align="left"/>
        <ScoreBlock/>
        <TeamName team={m.away} isWinner={winner===m.away} align="right"/>
...
function SchedTab({onAction}) {
  ...
  const selStyle=active=>({padding:"5px 12px",borderRadius:20,border:`1px solid ${active?C.green:C.b1}`,background:active?`${C.green}18`:"transparent",color:active?C.green:C.mid,fontSize:12,fontWeight:600,cursor:"pointer",whiteSpace:"nowrap"});
  return <div>
    ...
    {filterMode==="group"&&<div style={{display:"flex",gap:6,overflowX:"auto",paddingBottom:8,marginBottom:14,scrollbarWidth:"none"}}>
      {["All","A","B","C","D","E","F","G","H","I","J","K","L","Knockout"].map(g=><Pill key={g} active={groupF===g} onClick={()=>setGroupF(g)} color={g==="Knockout"?C.gold:C.green}>{g==="All"?"All Groups":g==="Knockout"?"🏆 KO":g}</Pill>)}
    </div>}
    {filterMode==="team"&&<div style={{marginBottom:14}}>
      ...
      {teamF&&<div style={{display:"flex",alignItems:"center",gap:10,marginTop:10,padding:"10px 14px",background:C.s2,borderRadius:10,border:`1px solid ${C.b1}`}}><Crest team={teamF} size={32}/><div><div style={{fontWeight:700,color:C.text,fontSize:15}}>{teamF}</div><div style={{fontSize:11,color:C.dim}}>{shown.length} match{shown.length!==1?"es":""}</div></div></div>}
    </div>}
    {filterMode==="venue"&&<div style={{marginBottom:14}}>
      ...
      {venueF&&<div style={{marginTop:10,padding:"10px 14px",background:C.s2,borderRadius:10,border:`1px solid ${C.b1}`}}><div style={{fontWeight:700,color:C.text,fontSize:13}}>📍 {venueF}</div><div style={{fontSize:11,color:C.dim,marginTop:3}}>{shown.length} match{shown.length!==1?"es":""}</div></div>}
    </div>}
    {shown.length===0
      ? <div style={{textAlign:"center",padding:"32px 20px",color:C.dim,fontSize:13}}>No matches found</div>
    ...
    <Card style={{marginTop:4}}><div style={{padding:14}}>
...
function LiveTab({onAction}) {
  ...
  // Find matches that have a live score entry
  ...
  const hasAny = liveMatches.length>0||finishedToday.length>0;
  ...
  return <div>
    <div style={{background:`linear-gradient(135deg,#0a1f10,#0c2815)`,border:`1px solid ${C.b2}`,borderRadius:12,padding:14,marginBottom:14}}>
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start"}}>
        <div>
          ...
          <div style={{fontSize:11,color:C.dim}}>Auto-refreshes every 60s · FIFA World Cup 2026</div>
        </div>
    ...
    {liveMatches.length>0&&<div>
      <div style={{fontSize:11,color:C.green,fontWeight:700,letterSpacing:"0.1em",textTransform:"uppercase",marginBottom:8}}>🔴 Live Now</div>
      {liveMatches.map(m=><MatchCard key={m.id} m={m} onAction={onAction}/>)}
    </div>}

    {finishedToday.length>0&&<div style={{marginTop:liveMatches.length?16:0}}>
      <div style={{fontSize:11,color:C.dim,fontWeight:700,letterSpacing:"0.1em",textTransform:"uppercase",marginBottom:8}}>Today's Results</div>
      {finishedToday.map(m=><MatchCard key={m.id} m={m} onAction={onAction}/>)}
    </div>}

    {!hasAny&&<div style={{textAlign:"center",padding:"48px 20px"}}>
  ...
  return <div>
    ...
    {d&&<div>
      <Card style={{marginBottom:12}}>
        <div style={{padding:16}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:8,marginBottom:12}}>
            {[["Titles",d.titles],["Form",d.form.slice(-3).join("")]].map(([l,v])=><div key={l} style={{background:C.s2,borderRadius:10,padding:"9px 8px",textAlign:"center"}}>
      ...
      {RECENT4[sel]&&<Card style={{marginTop:12}}>
        <div style={{padding:"11px 14px",borderBottom:`1px solid ${C.b1}`}}><span style={{fontWeight:700,color:C.green,fontSize:13,letterSpacing:"0.05em"}}>LAST 4 MATCHES</span></div>
        {RECENT4[sel].map((g,i)=>{
          ...
          return <div key={i} style={{padding:"11px 14px",borderBottom:i<3?`1px solid ${C.b1}`:"none"}}>
            <div style={{display:"flex",alignItems:"center",gap:8}}>
              ...
              <span style={{fontSize:10,padding:"2px 7px",borderRadius:10,background:g.comp==="Friendly"?`${C.dim}22`:`${C.blue}18`,color:g.comp==="Friendly"?C.dim:C.blue,fontWeight:600,whiteSpace:"nowrap",flexShrink:0}}>{g.comp}</span>
            </div>
          </div>;
        })}
      </Card>}
  ...
  return <div>
    <div style={{background:`linear-gradient(135deg,#0a1f10,#0c2815)`,border:`1px solid ${C.b2}`,borderRadius:12,padding:14,marginBottom:14}}>
      <div style={{display:"flex",justifyContent:"space-between",marginBottom:6}}>
        <div><div style={{fontWeight:700,fontSize:18,color:C.green}}>POLYMARKET ODDS</div><div style={{fontSize:11,color:C.dim}}>Live prediction market · Updated May 19, 2026</div></div>
...
// ── SIMULATOR TAB ─────────────────────────────────────────────────────────
function SimTab() {
  const [res,setRes]=useState(null),[running,setRunning]=useState(false),[sims,setSims]=useState(1000),[mc,setMc]=useState(null);
  ...
  return <div>
    ...
    {running&&<div style={{textAlign:"center",padding:"36px 0"}}><div style={{width:32,height:32,border:`3px solid ${C.green}`,borderTopColor:"transparent",borderRadius:"50%",animation:"spin .8s linear infinite",margin:"0 auto 10px"}}/><div style={{fontSize:13,color:C.mid}}>Running simulation...</div></div>}
    {!running&&mc&&<div>
      <div style={{fontWeight:700,color:C.gold,marginBottom:12,fontSize:16}}>MONTE CARLO · {sims} SIMULATIONS</div>
      {mc.slice(0,12).map((r,i)=><Card key={r.team} style={{marginBottom:6}}><div style={{padding:"9px 13px",display:"flex",alignItems:"center",gap:8}}>
    ...
    {saved.length===0?<div style={{textAlign:"center",padding:"50px 20px"}}>
      ...
      <div style={{background:`linear-gradient(135deg,#0a1f10,#0c2815)`,border:`1px solid ${C.b2}`,borderRadius:12,padding:14,marginBottom:16}}>
        ...
        <div style={{fontSize:11,color:C.dim,marginTop:8,lineHeight:1.6}}>
          <strong style={{color:C.mid}}>iPhone:</strong> Tap → Safari asks "Add to Calendar" → Add All<br/>
          <strong style={{color:C.mid}}>Android/Mac/PC:</strong> Downloads .ics → open to import
        </div>
      </div>
      ...
      {saved.length>1&&<button onClick={handleSync} style={{width:"100%",padding:"11px 0",borderRadius:10,cursor:"pointer",background:`${C.green}22`,border:`1px solid ${C.greenS}`,color:C.green,fontWeight:700,fontSize:14,marginTop:8}}>⬇️ Sync all {saved.length} matches to Calendar</button>}
    </div>}
  </div>;
}
